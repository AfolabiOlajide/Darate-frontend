...
const Home: NextPage = () => {
  ...
  return (
    <div className="mb-[3rem]">
      ...
      <p className='mt-4 w-[90%] md:w-[70%] text-base md:text-[1.7rem] leading-[1.7rem] md:leading-[2.5rem]'><span className='text-blu'>Darate</span> is a crowdfunding platform that allows you to do so, you can also support your favorite creators or if you're just looking to help those in need and support their campaign this is the right platform for you, built on the blockchain and fully powered by the Scroll Sepolia Network.</p>
      ...
      {/* Creator Section */}
      <h2 className='heading text-[2rem] md:text-[3rem] mt-[5rem]'>Let's aid you <br /> in providing Funds <br /> for your favourite <br /> <span className='text-blu text-[3rem] md:text-[4rem]'>Creator</span></h2>
      ...
      <div className="flex justify-center items-center">
        <CustomButton btnType='button' styles='hover:scale-110 transition-all duration-300 ease-in-out shadow bg-dark mt-[4rem] text-base md:text-[1.4rem]' title='Donate ❤️' handleClick={() => router.push("/creators/0")} />
      </div>
    </div>
  )
}
